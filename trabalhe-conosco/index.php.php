...
<form method="POST"  action="endereco.php" enctype="multipart/form-data">
...
<div class="text-left form-group row">
  ...
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-4 col-form-label col-form-label-lg">Nome Completo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="nome" value="" type="text" required="required"  pattern="([aA-zZ ]+)" placeholder="Digite seu Nome Completo"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg">Email</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="email" value="" type="email"  required="required" placeholder="Digite seu E-mail"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-5 col-form-label col-form-label-lg">Data de Nascimento</label>
      <div class="col-sm-7">
      <input class="form-control text-uppercase"  name="nascimento" value="" type="date"  required="required"  placeholder="Digite sua data de Nascimento"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-4 col-form-label col-form-label-lg">Estado</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="estado" value="" type="text" pattern="([aA-zZ ]+)" required="required" placeholder="Digite seu Estado"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg">Cidade</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="cidade" value="" type="text" pattern="([aA-zZ ]+)" required="required" placeholder="Digite seu Bairro"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg">Bairro</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="bairro" value="" type="text"  required="required" placeholder="Digite seu Bairro"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-4 col-form-label col-form-label-lg">CEP</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="cep" value="" type="text"  required="required"  placeholder="Digite seu cep"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg">Endereço</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="endereco" value="" type="text"  required="required"  placeholder="Digite seu Endereço completo"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg">Celular</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="telefone" value="" type="tel" required="required" pattern="[0-9]+$"  placeholder="Somente Números"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-4 col-form-label col-form-label-lg">Celular 2</label>
      <div class="col-sm">
      <input class="form-control text-uppercase"  name="telefone2" value="" type="tel" pattern="[0-9]+$" placeholder="Somente Números"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
...
<label class="col-sm-3 col-form-label col-form-label-lg">Escolaridade</label>
      <div class="col-sm">
    <select class="form-select" id="validationServer01"  name="escolaridade" aria-label="Default select example"  required>
   <!---- <option selected>Selecione uma opção</option> -->
        <option selected  value="Fundamental_Completo">Fundamental Completo/Cursando</option>
        <option value="Médio Completo/Imcompleto">Médio Completo/Cursando</option>
        <option value="Superior Completo/Cursando">Superior Completo/Cursando</option>
        <option value="Pós-graduação/Cursando">Pós-graduação Completo/Cursando</option>
        </select>
        </div>
  </div>
...
<label class="col-sm-2 col-form-label col-form-label-lg">Função</label>
      <div class="col-sm">
   ...
   <!---- <option selected>Selecione uma opção</option> -->
        ...
        <option value="3">Manutenção de ônibus (Mecânico)</option>
        <option selected value="4">Administrativo</option>
        </select>
  ...
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-6 col-form-label col-form-label-lg" id="validadetitulo" > Data de valildade da CNH </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="validade" name="validade" value="" type="date"   placeholder="Digite sua data de Nascimento"> 
      </div>
  </div>

  <div class="row col-sm-4">
    <label class="col-sm-5 col-form-label col-form-label-lg">Deseja Ingressar na  </label>
          <div class="col-sm">
  ...
  <div class="row col-sm-4">
    <label class="col-sm-8 col-form-label col-form-label-lg" id="validadetitulo" > Portador de necessidades especiais ?</label>
        ...
        <div class="form-check" onchange="exibir_necessidade(this)">
          ...
          <input class="form-check-input"  value="nao" type="radio"  name="especial" id="flexRadioDefault2" >
  ...
  <div class="row col-sm-4 pr-80">
    <label class="col-sm-5 col-form-label col-form-label-lg" id="simptitulo">Qual a necessidade ?</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="validadetitulo" >Tem indicação ?</label>
    
        <div class="row col-sm-2 pt-2">
        <div class="form-check" onchange="exibir_indicacao(this)">
          <input class="form-check-input" value="sim" type="radio" name="indicacao" id="flexRadioDefault1">
          <label class="form-check-label"  for="flexRadioDefault1">
          Sim
          </label>
          </div>
          ...
          <input class="form-check-input"  value="nao" type="radio"  name="indicacao" id="flexRadioDefault2" >
          <label class="form-check-label" for="flexRadioDefault2">
          Não
          </label>
          </div>
  ...
  <div class="row col-sm-8 pr-80">
    <label class="col-sm-5 col-form-label col-form-label-lg" id="tindicacao">Matricula e Nome de quem indicou</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="validadetitulo" > Ex-funcionário  ?</label>
   
        <div class="row col-sm-2 pt-2">
        <div class="form-check" onchange="exibir_func(this)">
          <input class="form-check-input" value="sim" type="radio" name="func" id="flexRadioDefault1">
          <label class="form-check-label"  for="flexRadioDefault1">
          Sim
          </label>
          </div>
          ...
          <input class="form-check-input"  value="nao" type="radio"  name="func" id="flexRadioDefault2" >
          <label class="form-check-label" for="flexRadioDefault2">
          Não
          </label>
          </div>
  ...
  <div class="row col-sm-8 pr-80">
    <label class="col-sm-5 col-form-label col-form-label-lg" id="func">Digite sua Antiga matricula</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-3">
    ...
    <label class="col-sm-5 col-form-label col-form-label-lg"> Possui Experiência ? </label>
          <div class="col-sm">
       ...
       <!---- <option selected>Selecione uma opção</option> -->
            ...
            <option value="1">1 Emprego</option>
            <option value="2">2 Empregos </option>
            <option value="3">3 Empregos </option>
            <option value="4">4 Empregos </option>
            <option value="5">5 Empregos </option>
            </select>
            </div>
      </div>
  
  <div class="row col-sm-8 pb-3">
  </div>

  <div class="row col-sm-4 pb-1">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsn1">Empresa 1 </label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsd1">Admissão </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dt1" name="admissao1" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsdd1">Demissão</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dtd1" name="demissão1" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsc1">Cargo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="hcargo1" name="hcargo1" value="" type="text"  placeholder="Digite seu cargo"> 
      </div>
  </div>
  <div class="row col-sm-8 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsm1">Motivo da Demissão</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsn2">Empresa 2 </label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsd2">Admissão </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dt2" name="admissao2" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsdd2">Demissão</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dtd2" name="demissão2" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsc2">Cargo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="hcargo2" name="hcargo2" value="" type="text"  placeholder="Digite seu cargo"> 
      </div>
  </div>
  <div class="row col-sm-8 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsm2">Motivo da Demissão</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsn3">Empresa 3 </label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsd3">Admissão </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dt3" name="admissao3" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsdd3">Demissão</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dtd3" name="demissão3" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsc3">Cargo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="hcargo3" name="hcargo3" value="" type="text"  placeholder="Digite seu cargo"> 
      </div>
  </div>
  <div class="row col-sm-8 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsm3">Motivo da Demissão</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsn4">Empresa 4</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsd4">Admissão </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dt4" name="admissao4" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsdd4">Demissão</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dtd4" name="demissão4" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsc4">Cargo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="hcargo4" name="hcargo4" value="" type="text"  placeholder="Digite seu cargo"> 
      </div>
  </div>
  <div class="row col-sm-8 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsm4">Motivo da Demissão</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsn5">Empresa 5 </label>
      <div class="col-sm">
  ...
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsd5">Admissão </label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dt5" name="admissao5" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-1">
    <label class="col-sm-4 col-form-label col-form-label-lg" id="dsdd5">Demissão</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="dtd5" name="demissão5" value="" type="date"> 
      </div>
  </div>
  <div class="row col-sm-4 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsc5">Cargo</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="hcargo5" name="hcargo5" value="" type="text"  placeholder="Digite seu cargo"> 
      </div>
  </div>
  <div class="row col-sm-8 pb-3">
    <label class="col-sm-3 col-form-label col-form-label-lg" id="dsm5">Motivo da Demissão</label>
      <div class="col-sm">
  ...
  <div class="row col-sm-12 pb-3">
    <label class="col-sm-2 col-form-label col-form-label-lg" id="dsh">Conte sua historia</label>
      <div class="col-sm">
      <input class="form-control text-uppercase" id="historia" name="historia" value="" type="text" placeholder="Digite sua historia "> 
      </div>
  </div>
  
  <div class="row col-sm-12 pb-3 ">
        <?php if ($msg != false) echo "<div class=\"alert $class\" role=\"alert\">$msg</div>"; ?>
           <label class="col-sm-2 col-form-label col-form-label-lg" > Anexar QNIS:</label>
           <input type="hidden" name="enviou" value="1">
           <div class="col-sm"
          <center> <input type="file" class="form-control" required name="arquivo"> </center>
  </div>
  ...
  <label class="font-weight-bold text-danger"> <h5> Termo de Aceite <h5> </label>
